...
export const CONFIG = {
    ...
    audioModules: [
        {
            id: 'mod-diseno-original-cuerpo',
            layer: 'eje',
            eje: 'cuerpo',
            title: 'DISEÑO ORIGINAL — CUERPO: La Fisiología de la Santidad',
            coverImageUrl: '/portada-cuerpo.png',
    ...
    themes: [
            ...
            slides: [
                {
                    ...
                    imageUrl: '/portada-el-dia-que-dejaste.png',
        ...
        // ── ARCHIVO (RECURSOS) · SEMANA 23 · Mar May 5, 2026 ────────────────────
        {
            ...
            themeStyles: {
                bg: '#ecebe5',
                textPrimary: '#383838',
                textSecondary: 'rgba(56, 56, 56, 0.65)',
                accent: '#7C4A2D',
                fontSerif: 'Lora, Georgia, serif',
                fontSans: 'Inter, system-ui, sans-serif',
                cardBorder: 'none',
                cardShadow: '0 5px 30px rgb(0 0 0 / 0.06)',
                backgroundImage: 'none',
            },
            slides: [
                {
                    ...
                    imageUrl: '/portada-somos-manos.jpg',
        ...
        // ── ARCHIVO (RECURSOS) · SEMANA 23 · Jue May 7, 2026 ────────────────────
        {
            id: 37,
            weekId: 23,
            availableFrom: "2026-05-07T00:00:00",
            title: "EL RUIDO QUE TE ESTÁ VACIANDO",
            description: "Y lo que Dios tiene que decirte al respecto.",
            styleVariant: 'contemplativo',
            themeStyles: {
                bg: '#F9F6F1',
                textPrimary: '#2C2218',
            ...
            slides: [
                ...
                },
                {
                    type: 'diagnostic',
                    label: 'EL DIAGNÓSTICO',
                    title: 'El 39% de los adultos en el mundo se preocupa todos los días.',
                    body: 'No es debilidad.\nNo es falta de voluntad.\nEs una señal.\nAlgo en el fundamento falló.',
                },
                {
                    type: 'diagnostic',
                    label: 'EL PROBLEMA REAL',
                    title: 'No es la economía. No es la incertidumbre. No es la soledad.',
                    body: 'El problema es que el ser humano fue diseñado para habitar en paz — y está intentando construirla sobre lo que se mueve.',
                    citation: '¿Por qué gastáis el dinero en lo que no es pan, y vuestro trabajo en lo que no sacia?',
                    reference: 'Isaías 55:2 (RVA)',
                },
                {
                    type: 'diagnostic',
                    label: 'LA LEY QUE DIOS ESCRIBIÓ PRIMERO',
                    title: 'Dios lo sabía desde Éxodo.',
                    body: 'No era una regla religiosa. Era ingeniería humana.\n\nTodo lo que colocas en el centro de tu vida como fuente de paz — te va a fallar.\nSolo uno no falla.',
                    citation: 'No tendrás dioses ajenos delante de mí.',
                    reference: 'Éxodo 20:3 (RVA)',
                },
                {
                    type: 'diagnostic',
                    label: 'EL CUMPLIMIENTO · JESÚS',
                    title: 'Jesús no ignoró la ansiedad. La diagnosticó.',
                    body: 'La palabra griega merimnáo — afanarse — significa dividir la mente.\n\nLa ansiedad te parte en pedazos porque sirves a dos señores al mismo tiempo.',
                    citation: 'No os afanéis por vuestra vida, qué habéis de comer o qué habéis de beber... ¿No es la vida más que el alimento?',
                    reference: 'Mateo 6:25 (RVA)',
                },
                {
                    type: 'diagnostic',
                    label: 'LA EXPLICACIÓN APOSTÓLICA · PABLO',
                    title: 'Pablo no predicó resignación. Predicó protocolo.',
                    body: 'El antídoto a la ansiedad no es ignorar el problema.\nEs reorientar a quién se lo llevas.',
                    citation: 'Por nada estéis afanosos; antes bien, en todo, mediante oración y súplica con acción de gracias, sean dadas a conocer vuestras peticiones delante de Dios.',
                    reference: 'Filipenses 4:6 (RVA)',
                },
                {
                    type: 'diagnostic',
                ...
                {
                    type: 'action',
                    title: 'Tres movimientos para salir del ruido',
                    subtitle: 'No como ritual. Como acto consciente.',
                    steps: [
                        'Identifica el dios falso — ¿Qué cosa estás creyendo que tiene que darte lo que solo Dios da?',
                        'Reorienta la carga — Llévala en oración. Suelta el control.',
                        'Ocupa tu mente con lo verdadero — "Todo lo que es verdadero... en esto pensad." — Fil. 4:8',
                    ],
                },
                {
                    type: 'diagnostic',
                    label: 'LA PROMESA',
                    title: 'No dijo que entenderías todo.',
                    body: 'Dijo que algo más grande que tu entendimiento haría guardia en tu interior.\n\nEso no lo da ningún sistema. Ninguna app. Ningún método.',
                    citation: 'Y la paz de Dios, que sobrepasa todo entendimiento, guardará vuestros corazones y vuestras mentes en Cristo Jesús.',
                    reference: 'Filipenses 4:7 (RVA)',
                },
                {
                    type: 'action',
                    title: 'El ruido no para solo.',
                    subtitle: 'Pero hay una puerta a la que puedes tocar que siempre está abierta.',
                    steps: [
                        'Guarda este carrusel para volver cuando el ruido regrese.',
                        'Compártelo con alguien que lo necesite hoy.',
                    ],
                    citation: 'Venid a mí todos los que estáis trabajados y cargados, y yo os haré descansar.',
                    reference: 'Mateo 11:28 (RVA)',
                },
            ],
        },
        ...
        // Invalid themes (Weeks 12-15) removed as per user request.
        {
            id: 16,
            weekId: 8,
